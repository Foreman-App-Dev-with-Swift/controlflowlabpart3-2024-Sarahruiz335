...
var curentHR = 90
var targetHR = 100
let isInTarget = (curentHR == targetHR )
let isBlowtarget = (curentHR < targetHR)
let isAboveTarget = (curentHR > targetHR )
if (isInTarget) {
    print("your right on track ")
}
else if (isBlowtarget) {
    print("your doing great but try to push it a bit ")
}
else {
    print("your on fire slow down a bit ")
}
